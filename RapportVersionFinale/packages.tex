\usepackage[left=2cm,right=2cm,top=2cm,bottom=2cm,headsep=11pt,a4paper]{geometry}
\usepackage{xcolor}
...
\usepackage[colorlinks=true,
        ...
        pdftitle={Réalisation d'un programme d'aide au diagnostique, application sur les pathologies cérébrales.},
        pdfsubject={Mine !}] {hyperref}
\usepackage{url}
...
% pour des entêtes et pieds de pages améliorés.
%\usepackage{fancyhdr}
