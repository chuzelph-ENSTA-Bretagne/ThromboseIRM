...
% Ajout du logo
%\titlegraphic{\includegraphics[height=1cm,width=2cm]{ensta-bretagne-vertical.png}}
...
%\url{IRMsain.avi}
\movie[height = 0.55\textwidth, width = 1\textwidth, poster, showcontrols]{\includegraphics[scale=0.2]{Plain-Black-Wallpaper.png}}{IRMsain.avi}
...
\movie[height = 0.55\textwidth, width = 1\textwidth, poster, showcontrols]{\includegraphics[scale=0.2]{Plain-Black-Wallpaper.png}}{videoOut17.avi}
%\url{videoOut17.avi}
...
\movie[height = 0.55\textwidth, width = 1\textwidth, poster, showcontrols]{\includegraphics[scale=0.2]{Plain-Black-Wallpaper.png}}{videoOut13.avi}
